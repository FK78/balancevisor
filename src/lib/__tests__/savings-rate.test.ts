...
describe("computeMonthlySavingsRates", () => {
  ...
  it("returns 0 rate when income is 0", () => {
    const result = computeMonthlySavingsRates([
      { month: "2025-01", income: 0, expenses: 500, refunds: 0, net: -500 },
    ]);
  ...
  it("handles negative net (spending > income)", () => {
    const result = computeMonthlySavingsRates([
      { month: "2025-01", income: 1000, expenses: 1500, refunds: 0, net: -500 },
    ]);
  ...
  it("handles 100% savings rate", () => {
    const result = computeMonthlySavingsRates([
      { month: "2025-01", income: 1000, expenses: 0, refunds: 0, net: 1000 },
    ]);
  ...
  it("processes multiple months", () => {
    const result = computeMonthlySavingsRates([
      { month: "2025-01", income: 3000, expenses: 2000, refunds: 0, net: 1000 },
      { month: "2025-02", income: 3000, expenses: 3000, refunds: 0, net: 0 },
      { month: "2025-03", income: 3000, expenses: 1000, refunds: 0, net: 2000 },
    ]);
