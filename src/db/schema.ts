...
export const zakatCalculationsTable = pgTable("zakat_calculations", {
  ...
  nisab_value: numeric("nisab_value").notNull(),
  total_assets: numeric("total_assets").notNull(),
  cash_and_savings: numeric("cash_and_savings").notNull().default(0),
  investment_value: numeric("investment_value").notNull().default(0),
  total_liabilities: numeric("total_liabilities").notNull().default(0),
  debt_deductions: numeric("debt_deductions").notNull().default(0),
  zakatable_amount: numeric("zakatable_amount").notNull(),
  zakat_due: numeric("zakat_due").notNull(),
